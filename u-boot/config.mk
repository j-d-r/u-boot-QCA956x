...
CPPFLAGS	:=
AFLAGS		:=
CFLAGS		:= -Os -ggdb3 -Wall -Wextra -Wno-unused-parameter -Wno-sign-compare -Wstrict-prototypes $(cc-option,-Wshift-overflow=2) -flto -fuse-linker-plugin
LDFLAGS		:= -fwhole-program -Wl,--gc-sections
ARFLAGS		:=
OBJCFLAGS	:=
