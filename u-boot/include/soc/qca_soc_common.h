...
/* GPIO_IN_ENABLE3 register (GPIO in signals 3) */
#define QCA_GPIO_IN_EN3_GE1_MII_MDI_SHIFT	16
#define QCA_GPIO_IN_EN3_GE1_MII_MDI_MASK	BITS(QCA_GPIO_IN_EN3_GE1_MII_MDI_SHIFT ,8)
...
#define QCA_PLL_DDR_PLL_DITHER_NFRAC_STEP_MASK			BITS(QCA_PLL_DDR_PLL_DITHER_NFRAC_STEP_SHIFT, 7)
...
#define QCA_PLL_DDR_PLL_DITHER2_NFRAC_MAX_H_MASK	BITS(QCA_PLL_DDR_PLL_DITHER2_NFRAC_MAX_H_SHIFT, 13)
	...
	/* CPU_PLL_DITHER register (CPU PLL dither parameter) */
		...
		#define QCA_PLL_CPU_PLL_DITHER_NFRAC_STEP_MASK		BITS(QCA_PLL_CPU_PLL_DITHER_NFRAC_STEP_SHIFT, 6)
...
#define QCA_PLL_SRIF_AUD_DPLL_BASE_REG		QCA_PLL_SRIF_BASE_REG + 0x200
	...
	#define QCA_PLL_SRIF_PCIE_PHY_REG_1_REG	QCA_PLL_SRIF_BASE_REG + 0xE00
#else
...
#define QCA_PLL_SRIF_PCIE_PHY_REG_1_S_SHIFT	0
#define QCA_PLL_SRIF_PCIE_PHY_REG_1_S_MASK	BITS(QCA_PLL_SRIF_PCIE_PHY_REG_1_S_SHIFT, 3)
#define QCA_PLL_SRIF_PCIE_PHY_REG_1_S_RESET	0x7

#if (SOC_TYPE & QCA_QCA956X_SOC)
	#define QCA_BIAS4_REG				QCA_PLL_SRIF_BASE_REG + 0x0CC
	#define QCA_BIAS5_REG				QCA_PLL_SRIF_BASE_REG + 0x0D0
#endif
...
#if (SOC_TYPE & QCA_QCA955X_SOC)
	#define QCA_RST_PCIEEP_INTR_MASK_REG	QCA_RST_BASE_REG + 0xC8
	#define QCA_RST_CLK_GAT_EN_REG		QCA_RST_BASE_REG + 0xCC
#endif

#if (SOC_TYPE & QCA_QCA956X_SOC)
	#define QCA_RST_MISC2_REG		QCA_RST_BASE_REG + 0xB8
	#define QCA_RST_RESET2_REG		QCA_RST_BASE_REG + 0xC0
	#define QCA_RST_CLK_GAT_EN_REG		QCA_RST_BASE_REG + 0xC8
#else
...
/* RST_CLKGAT_EN (QCA956x) */
#define QCA_RST_CLK_GAT_EN_WMAC_SHIFT			9
#define QCA_RST_CLK_GAT_EN_WMAC_MASK			BIT(QCA_RST_CLK_GAT_EN_WMAC_SHIFT)
#define QCA_RST_CLK_GAT_EN_USB2_SHIFT			8
#define QCA_RST_CLK_GAT_EN_USB2_MASK			BIT(QCA_RST_CLK_GAT_EN_USB2_SHIFT)
#define QCA_RST_CLK_GAT_EN_USB1_SHIFT			7
#define QCA_RST_CLK_GAT_EN_USB1_MASK			BIT(QCA_RST_CLK_GAT_EN_USB1_SHIFT)
#define QCA_RST_CLK_GAT_EN_GE1_SHIFT			6
#define QCA_RST_CLK_GAT_EN_GE1_MASK			BIT(QCA_RST_CLK_GAT_EN_GE1_SHIFT)
#define QCA_RST_CLK_GAT_EN_GE0_SHIFT			5
#define QCA_RST_CLK_GAT_EN_GE0_MASK			BIT(QCA_RST_CLK_GAT_EN_GE0_SHIFT)
#define QCA_RST_CLK_GAT_EN_CLK100_PCIERC2_SHIFT		4
#define QCA_RST_CLK_GAT_EN_CLK100_PCIERC2_MASK		BIT(QCA_RST_CLK_GAT_EN_CLK100_PCIERC2_SHIFT)
#define QCA_RST_CLK_GAT_EN_CLK100_PCIERC_SHIFT		3
#define QCA_RST_CLK_GAT_EN_CLK100_PCIERC_MASK		BIT(QCA_RST_CLK_GAT_EN_CLK100_PCIERC_SHIFT)
#define QCA_RST_CLK_GAT_EN_PCIE_RC2_SHIFT		2
#define QCA_RST_CLK_GAT_EN_PCIE_RC2_MASK		BIT(QCA_RST_CLK_GAT_EN_PCIE_RC2_SHIFT)
#define QCA_RST_CLK_GAT_EN_PCIE_RC_SHIFT		1
#define QCA_RST_CLK_GAT_EN_PCIE_RC_MASK			BIT(QCA_RST_CLK_GAT_EN_PCIE_RC_SHIFT)
#define QCA_RST_CLK_GAT_EN_PCIE_EP_SHIFT		0
#define QCA_RST_CLK_GAT_EN_PCIE_EP_MASK		 	BIT(QCA_RST_CLK_GAT_EN_PCIE_EP_SHIFT)
...
#define QCA_RST_REVISION_ID_MAJOR_AR71XX_VAL		0x00a0
#define QCA_RST_REVISION_ID_MAJOR_AR913X_VAL		0x00b0
#define QCA_RST_REVISION_ID_MAJOR_AR7240_VAL		0x00c0
#define QCA_RST_REVISION_ID_MAJOR_AR7241_VAL		0x0100
#define QCA_RST_REVISION_ID_MAJOR_AR7242_VAL		0x1100
...
#define QCA_RST_REVISION_ID_MAJOR_QCA9556_VAL		0x0130
#define QCA_RST_REVISION_ID_MAJOR_QCA9558_VAL		0x1130
#define QCA_RST_REVISION_ID_MAJOR_QCA956X_VAL		0x1150
#define QCA_RST_REVISION_ID_MAJOR_TP9343_VAL		0x0150
